...
const player = $argument.Player || "Safari";

// 播放器映射表
const playerMap = {
    "Safari": null,
    "SenPlayer": "SenPlayer://x-callback-url/play?url=",
    "Filebar": "filebox://play?url=", // 确认是否正确
    "yybp": "yybp://",
    "Alook": "alook://",
    "Stay": "stay://x-callback-url/open-download?url=",
    "VLC": "vlc://", // 添加 VLC 测试
    "Infuse": "infuse://x-callback-url/play?url=" // 添加 Infuse 测试
};
...
const mediaMap = {
    ...
    "Filebar": "https://example.com/filebar.png",
    "yybp": "https://example.com/yybp.png",
    "Alook": "https://example.com/alook.png",
    "Stay": "https://example.com/stay.png",
    "VLC": "https://example.com/vlc.png",
    "Infuse": "https://example.com/infuse.png",
